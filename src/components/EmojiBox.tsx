...
const EmojiBox = (params:emojiBoxParams) => {
    ...
    return (<div className={`${emojiBoxStyles.emojiBox} ${selectedEmoji===emoji?emojiBoxStyles.emojiBoxSelected: emojiBoxStyles.emojiBoxNotSelected}`} onClick={()=>{setSelectedEmoji(emoji)}}>
